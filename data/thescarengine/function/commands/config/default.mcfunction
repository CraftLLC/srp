execute unless data storage thescarengine:temp p.rules.drop_car_item_to_inventory run data modify storage thescarengine:temp p.rules.drop_car_item_to_inventory set value 1
execute unless data storage thescarengine:temp p.rules.allow_relocator_while_riding run data modify storage thescarengine:temp p.rules.allow_relocator_while_riding set value 1
execute unless data storage thescarengine:temp p.rules.tce_disable_confirmation run data modify storage thescarengine:temp p.rules.tce_disable_confirmation set value 1
